...
from jobspy.util import (
    ...
    extract_skills_from_attributes,
)
...
class Indeed(Scraper):
    ...
    def _process_job(self, job: dict) -> JobPost | None:
        ...
        # Extract skills from attributes and description
        skills_from_attributes = extract_skills_from_attributes(job["attributes"])
        skills_from_description = extract_skills_from_description(description)
        # Combine and deduplicate skills
        all_skills = list(set(skills_from_attributes + skills_from_description))
        return JobPost(
            id=f'in-{job["key"]}',
            title=job["title"],
