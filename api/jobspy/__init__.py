...
from jobspy.jsjobbs import JSJobbs
from jobspy.linkedin import LinkedIn
from jobspy.naukri import Naukri
from jobspy.producthunt import ProductHunt
...
def scrape_jobs(
    ...
    **kwargs,
    ...
    SCRAPER_MAPPING = {
        ...
        Site.JSJOBBS: JSJobbs,  # Add JSJobbs to the scraper mapping
        Site.PRODUCTHUNT: ProductHunt,  # Add ProductHunt to the scraper mapping
    }
...
# Add BDJobs and ProductHunt to __all__
__all__ = [
    "BDJobs",
    "ProductHunt",
]